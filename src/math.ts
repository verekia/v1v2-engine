...
export function m4Identity(out: Float32Array, o: number): void {
  ...
  out[o + 8] = 0;  out[o + 9] = 0;  out[o + 10] = 1; out[o + 11] = 0
...
export function m4Perspective(
  ...
  out[o] = f / aspect; out[o + 1] = 0; out[o + 2] = 0;  out[o + 3] = 0
  out[o + 4] = 0;      out[o + 5] = f; out[o + 6] = 0;  out[o + 7] = 0
  out[o + 8] = 0;       out[o + 9] = 0; out[o + 10] = far * rangeInv; out[o + 11] = -1
  out[o + 12] = 0;      out[o + 13] = 0; out[o + 14] = near * far * rangeInv; out[o + 15] = 0
}
...
export function m4LookAt(
  ...
  out[o] = sx;   out[o + 1] = ux;   out[o + 2] = -fx;  out[o + 3] = 0
  out[o + 4] = sy;   out[o + 5] = uy;   out[o + 6] = -fy;  out[o + 7] = 0
  out[o + 8] = sz;   out[o + 9] = uz;   out[o + 10] = -fz; out[o + 11] = 0
...
export function m4ExtractFrustumPlanes(
  out: Float32Array,
  m: Float32Array,
  mo: number,
): void {
  // Column-major row accessors: row i = m[mo+i], m[mo+i+4], m[mo+i+8], m[mo+i+12]
  const m0 = m[mo]!,     m1 = m[mo + 1]!,  m2 = m[mo + 2]!,  m3 = m[mo + 3]!
  const m4 = m[mo + 4]!, m5 = m[mo + 5]!,  m6 = m[mo + 6]!,  m7 = m[mo + 7]!
  const m8 = m[mo + 8]!, m9 = m[mo + 9]!,  m10 = m[mo + 10]!, m11 = m[mo + 11]!
  const m12 = m[mo + 12]!, m13 = m[mo + 13]!, m14 = m[mo + 14]!, m15 = m[mo + 15]!
...
export function m4FromTRS(
  ...
  const rx = rot[ro]!,  ry = rot[ro + 1]!, rz = rot[ro + 2]!
